...
const AboutUs = () => {
  return (
    <>
      <section id="about" className={`relative background2 overflow-hidden min-h-[100vh] ${styles.padding} `}>    
         <Gradient2 />
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0 flex flex-col gap-5">
                ...
                <a
                  ...
                  className="inline-flex mt-5 max-w-[200px] items-center justify-center py-3 text-base font-medium text-center text-white border border-transparent rounded-md px-7 bg-blue-500 hover:bg-opacity-90"
                >
                  Get Started
                </a>
              </div>
