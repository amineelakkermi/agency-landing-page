        ...
        <div className={`container mx-auto max-w-7xl ${styles.paddingX}`}>
          <div className="w-full flex justify-between flex-wrap">
            <div>
              ...
              <div className="text-primary shrink-0 text-[25px] font-bold">
              <a href="#home" 
              className="text-primary kufam">
              LAUNCHLY
              </a>
                </div>
                <p className="mb-7 text-base text-secondary max-w-[450px]">
              ...
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    ...
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-primary hover:border-primary hover:bg-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
...
const NavLink = ({ link, label }) => {
  return (
    <li>
        <a
        href={link}
        className="inline-block text-base leading-loose text-secondary hover:text-primary"
      >
        {label}
      </a>
    </li>
